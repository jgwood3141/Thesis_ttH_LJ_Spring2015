...
and mechanical support structures that compose CMS.  Geant 4 also
...
\hline
$Z/\gamma^* +$~jets & & \\
$M\_{\ell\ell} > $50 GeV/c$^2$ & DYJets to Leptons $M_{\ell\ell}>$50, Madgraph & 3503.17 pb \\
10 GeV/c$^2 < M\_{\ell\ell} < $50 GeV/c$^2$ & DYJets to Leptons
...
which is referred to as "in-time'' pileup.  Alternatively,
